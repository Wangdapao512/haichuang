...
//ShapeLib includes
#include <E:\libs\shapelib-1.3.0\shapefil.h>
...
public:
	...
	bool readSHPInfo(const std::string &filename, int &shapeType, int &numberOfEntities){ return true; }
	...
	static bool write2dMeshToSHP(const std::string &file_name, const MeshLib::Mesh &mesh){ return true; }
